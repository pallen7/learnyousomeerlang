...
init([Role, Skill]) ->
    ...
    random:seed(now()), % rand(erlang:timestamp(milli_seconds))
...
% note: if no message is received by before the deadline the timeout atom is sent to the server
...
firstnames() -> ["Valerie", "Arnold", "Carlos", "Dorothy", "Keesha", "Phoebe", "Ralphie", "Tim", "Wanda", "Janet"].
lastnames() -> ["Frizzle", "Perlstein", "Ramon", "Ann", "Franklin", "Terese", "Tennelli", "Jamal", "Li", "Perlstein"].
